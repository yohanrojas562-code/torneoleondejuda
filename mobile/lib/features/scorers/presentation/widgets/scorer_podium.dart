...
/// Podio del top 3 goleadores. #1 hero card prominente arriba, #2 y #3 lado
/// a lado debajo. Tap → bottom sheet con detalle.
class ScorerPodium extends StatelessWidget {
  const ScorerPodium({
    required this.top1,
    required this.top2,
    required this.top3,
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        _HeroCard(scorer: top1, onTap: () => onTap(top1)),
